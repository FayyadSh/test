...
// ------------ Images ----------------
import SpaceImage from '@/assets/svg/space.svg'
...
const AboutUs = () => {
  return (
    <div className="bg-background-color dark:bg-background-dark-color relative flex items-center justify-center overflow-hidden pt-20">
     <Image src={SpaceImage} className='absolute right-0 opacity-50 bottom-0 h-80 w-80 lg:w-[700px] lg:h-[700px]' width={400} height={400} alt='' />
      <div className="relative mx-auto h-full px-4 pb-20 md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className=" relative ">
            <div className="lg:max-w-xl lg:pr-5 relative">
              <p className="flex text-sm uppercase text-g1 dark:text-gray-600">About Us</p>
              ...
              <p className="text-base text-gray-700">
                At Codesphere Courses, we are passionate about empowering
                individuals with the skills they need to succeed in today's
                tech-driven world. Our mission is to offer top-quality,
                affordable coding courses to learners at every stage of their
                journey.
              </p>
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <a
                  href="/"
                  className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-primary px-6 font-medium tracking-wide text-white shadow-md transition duration-300 hover:bg-primary/75 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  View More
                </a>
                <a
